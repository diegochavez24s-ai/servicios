        ...
        <div className="flex items-center justify-center min-h-screen bg-slate-900">
            <div className="bg-slate-800 p-8 rounded-2xl shadow-xl w-96 border border-slate-700">
                ...
                <div className="space-y-4">
                    <input type="text" placeholder="Usuario" className="w-full p-3 rounded-lg bg-slate-700 text-white" value={nombre} onChange={(e) => setNombre(e.target.value)} />
                    <input type="password" placeholder="Contraseña" className="w-full p-3 rounded-lg bg-slate-700 text-white" value={contra} onChange={(e) => setContra(e.target.value)} />
